                    ...
                    <div class="card-body" style="background-color: #fddedf">
                        <form>
                            ...
                            <div class="mb-3 col-sm-14">
                                ...
                                <input type="phonenum" class="form-control" id="inputPhoneNum"
                                    placeholder="(10-13 numbers)">
                            </div>
                            <div class="mb-3 col-sm-14">
                            ...
                            <button type="submit" class="btn col-12 mb-3"
                                style="background-color: #b5838d; color: white">Submit</button>
                            <div id="button" class="form-text text-center mb-4">Already Registered? <a
                                    href="{{ route('Sign In Page') }}">Sign in here</a></div>
